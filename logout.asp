...
<body background="images/backline.gif" topmargin=2 leftmargin="0" marginwidth=0 marginheight=2>
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr>
      ...
      <td align=center><img border="0" src="images/header_conquermarks.gif" alt="ConquerMarks 1.0" width="580" height="50"></td>
      <td width="50%">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td width="100%"><img border="0" src="images/dot.gif" width="1" height="31"></td>
...
<p class="Caption">logout of <strong>ConquerMarks</strong></p>

<p>You've logged out of ConquerMarks.</p>
